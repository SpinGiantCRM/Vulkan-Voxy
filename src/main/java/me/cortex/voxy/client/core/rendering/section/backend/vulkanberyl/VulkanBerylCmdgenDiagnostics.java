...
final class VulkanBerylCmdgenDiagnostics {
    ...
    static final boolean CMDGEN_CREATE_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_CREATE_ONLY", false);
    static final boolean CMDGEN_DISPATCH_NOOP = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DISPATCH_NOOP", false);
    static final boolean CMDGEN_DESCRIPTOR_NOOP_BIND_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DESCRIPTOR_NOOP_BIND_PROBE", false);
    static final boolean CMDGEN_UPLOAD_CONFIG_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_UPLOAD_CONFIG_ONLY", false);
    static final boolean CMDGEN_CLEAR_OUTPUTS_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_CLEAR_OUTPUTS_ONLY", false);
    static final boolean CMDGEN_BIND_FULL_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_BIND_FULL_ONLY", false);
    static final boolean CMDGEN_DISABLE_BIND_PIPELINE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DISABLE_BIND_PIPELINE", false);
    static final boolean CMDGEN_DISABLE_BIND_DESCRIPTORS = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DISABLE_BIND_DESCRIPTORS", false);
    static final boolean CMDGEN_DISABLE_DISPATCH_CALL = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DISABLE_DISPATCH_CALL", false);
    static final boolean CMDGEN_DISABLE_POST_DISPATCH_BARRIER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DISABLE_POST_DISPATCH_BARRIER", false);
    static final boolean CMDGEN_DISPATCH_NOOP_SAME_LAYOUT = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DISPATCH_NOOP_SAME_LAYOUT", false);
    static final boolean CMDGEN_SHADER_READ_RENDERLIST_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_RENDERLIST_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_RENDERLIST_HEADER_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_RENDERLIST_HEADER_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_RENDERLIST_COUNT_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_RENDERLIST_COUNT_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_RENDERLIST_ENTRY0_SECTION_ID_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_RENDERLIST_ENTRY0_SECTION_ID_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_RENDERLIST_ENTRY0_QUAD_START_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_RENDERLIST_ENTRY0_QUAD_START_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_RENDERLIST_ENTRY0_QUAD_COUNT_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_RENDERLIST_ENTRY0_QUAD_COUNT_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_METADATA_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_METADATA_ONLY", false);
    static final boolean CMDGEN_SHADER_WRITE_DRAWS_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_WRITE_DRAWS_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_BINDING0_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_BINDING0_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_BINDING0_ONLY_NO_OUTPUT_WRITE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_BINDING0_ONLY_NO_OUTPUT_WRITE", false);
    static final boolean CMDGEN_SHADER_READ_BINDING1_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_BINDING1_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_CONFIG_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_CONFIG_ONLY", false);
    static final boolean CMDGEN_SHADER_READ_RENDERLIST_METADATA_NO_WRITE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SHADER_READ_RENDERLIST_METADATA_NO_WRITE", false);
    static final boolean CMDGEN_RENDERLIST_ALT_BUFFER_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_RENDERLIST_ALT_BUFFER_PROBE", false);
    static final boolean CMDGEN_MINIMAL_TINY_SSBO_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_MINIMAL_TINY_SSBO_READ_PROBE", false);
    static final boolean CMDGEN_MINIMAL_RENDERLIST_MANUALUBO_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_MINIMAL_RENDERLIST_MANUALUBO_READ_PROBE", false);
    static final boolean CMDGEN_MINIMAL_CONFIG_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_MINIMAL_CONFIG_READ_PROBE", false);
    static final boolean CMDGEN_MINIMAL_CONFIG_BINDING0_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_MINIMAL_CONFIG_BINDING0_READ_PROBE", false);
    static final boolean CMDGEN_HARDCODED_READ_BINDING0_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_HARDCODED_READ_BINDING0_ONLY", false);
    static final boolean CMDGEN_FULL_LAYOUT_NOOP_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_NOOP_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_HARDCODED_BINDING0_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_HARDCODED_BINDING0_READ_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_CONFIG_BINDING0_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_CONFIG_BINDING0_READ_PROBE", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_SECTION_IMPORT_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_SECTION_IMPORT_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_CMDGEN_DECLS_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_CMDGEN_DECLS_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_SIMPLE_FLAG_BRANCH_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_SIMPLE_FLAG_BRANCH_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_READONLY_BRANCH_LADDER_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_READONLY_BRANCH_LADDER_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_FULL_BRANCH_LADDER_NO_HELPERS_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_FULL_BRANCH_LADDER_NO_HELPERS_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_HELPER_DECLS_UNUSED_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_HELPER_DECLS_UNUSED_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_HELPER_READONLY_USE_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_HELPER_READONLY_USE_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_FINAL_BLOCK_NO_OUTPUT_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_FINAL_BLOCK_NO_OUTPUT_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_FINAL_COMMAND_WRITE_NO_DRAWCOUNT_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_FINAL_COMMAND_WRITE_NO_DRAWCOUNT_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_FINAL_DRAWCOUNT_WRITE_ONLY_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_BINDING0_CONFIG_WITH_FINAL_DRAWCOUNT_WRITE_ONLY_SHADER", false);
    static final boolean CMDGEN_USE_FINAL_COMMAND_WRITE_CONSTANT_AFTER_METADATA_READ_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_FINAL_COMMAND_WRITE_CONSTANT_AFTER_METADATA_READ_SHADER", false);
    static final boolean CMDGEN_USE_FINAL_COMMAND_WRITE_COMPUTED_VERTEX_COUNT_ONLY_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_FINAL_COMMAND_WRITE_COMPUTED_VERTEX_COUNT_ONLY_SHADER", false);
    static final boolean CMDGEN_USE_FINAL_COMMAND_WRITE_COMPUTED_FIRST_VERTEX_ONLY_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_FINAL_COMMAND_WRITE_COMPUTED_FIRST_VERTEX_ONLY_SHADER", false);
    static final boolean CMDGEN_USE_FINAL_COMMAND_WRITE_CLAMPED_COMPUTED_COMMAND_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_FINAL_COMMAND_WRITE_CLAMPED_COMPUTED_COMMAND_SHADER", false);
    static final boolean CMDGEN_USE_COMMAND_WRITE_AFTER_RENDERLIST_READ_NO_METADATA_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_COMMAND_WRITE_AFTER_RENDERLIST_READ_NO_METADATA_SHADER", false);
    static final boolean CMDGEN_USE_COMMAND_WRITE_AFTER_METADATA0_READ_NO_RENDERLIST_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_COMMAND_WRITE_AFTER_METADATA0_READ_NO_RENDERLIST_SHADER", false);
    static final boolean CMDGEN_USE_COMMAND_WRITE_BEFORE_METADATA_READ_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_COMMAND_WRITE_BEFORE_METADATA_READ_SHADER", false);
    static final boolean CMDGEN_USE_COMMAND_WRITE_AFTER_VISIBLECOUNT_READ_ONLY_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_COMMAND_WRITE_AFTER_VISIBLECOUNT_READ_ONLY_SHADER", false);
    static final boolean CMDGEN_USE_COMMAND_WRITE_AFTER_INDIRECTLOOKUP0_READ_ONLY_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_COMMAND_WRITE_AFTER_INDIRECTLOOKUP0_READ_ONLY_SHADER", false);
    static final boolean CMDGEN_USE_COMMAND_WRITE_AFTER_RENDERLIST_READ_NO_BRANCH_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_COMMAND_WRITE_AFTER_RENDERLIST_READ_NO_BRANCH_SHADER", false);
    static final boolean CMDGEN_USE_COMMAND_WRITE_AFTER_VISIBLECOUNT_BRANCH_ONLY_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_COMMAND_WRITE_AFTER_VISIBLECOUNT_BRANCH_ONLY_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_DRAWCOUNT_LITERAL_ZERO_WRITE_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_DRAWCOUNT_LITERAL_ZERO_WRITE_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_DRAWCOUNT_LITERAL_ONE_WRITE_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_DRAWCOUNT_LITERAL_ONE_WRITE_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_DRAWCOUNT_NO_CONFIG_LITERAL_ZERO_WRITE_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_DRAWCOUNT_NO_CONFIG_LITERAL_ZERO_WRITE_SHADER", false);
    static final boolean CMDGEN_USE_STANDALONE_DRAWCOUNT_DECLARED_NO_WRITE_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_STANDALONE_DRAWCOUNT_DECLARED_NO_WRITE_SHADER", false);
    static final boolean CMDGEN_USE_FULL_NO_DRAWCOUNT_WRITE_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_FULL_NO_DRAWCOUNT_WRITE_SHADER", false);
    static final boolean CMDGEN_BIND_DRAWCOUNT_TO_SCRATCH_BUFFER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_BIND_DRAWCOUNT_TO_SCRATCH_BUFFER", false);
    static final boolean CMDGEN_USE_LARGE_DRAWCOUNT_BUFFER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_LARGE_DRAWCOUNT_BUFFER", false);
    static final boolean CMDGEN_DRAWCOUNT_DESCRIPTOR_RANGE_FULL_BUFFER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DRAWCOUNT_DESCRIPTOR_RANGE_FULL_BUFFER", false);
    static final boolean CMDGEN_USE_DRAWCOUNT_BUFFER_WITH_INDIRECT_USAGE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_DRAWCOUNT_BUFFER_WITH_INDIRECT_USAGE", false);
    static final boolean CMDGEN_USE_SCRATCH_ALLOCATION_FOR_REAL_DRAWCOUNT = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_SCRATCH_ALLOCATION_FOR_REAL_DRAWCOUNT", false);
    static final boolean CMDGEN_USE_PASSING_SCRATCH_BINDING_AS_REAL_DRAWCOUNT_DESCRIPTOR = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_PASSING_SCRATCH_BINDING_AS_REAL_DRAWCOUNT_DESCRIPTOR", false);
    static final boolean CMDGEN_SKIP_DRAWCOUNT_CLEAR_BEFORE_DISPATCH = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SKIP_DRAWCOUNT_CLEAR_BEFORE_DISPATCH", false);
    static final boolean CMDGEN_DISABLE_ANY_DRAWCOUNT_CONSUMER_PATH = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DISABLE_ANY_DRAWCOUNT_CONSUMER_PATH", false);
    static final boolean CMDGEN_DUMP_SHADER_DIAGNOSTICS = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DUMP_SHADER_DIAGNOSTICS", false);
    static final boolean CMDGEN_NO_IMPORT_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_PROBE", false);
    static final boolean CMDGEN_NO_IMPORT_READ_METADATA0_ONLY_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_READ_METADATA0_ONLY_PROBE", false);
    static final boolean CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_PROBE", false);
    static final boolean CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_TINY_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_TINY_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING1_NO_READ_TINY_BIND_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_NO_READ_TINY_BIND_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_CONST_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_CONST_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_NO_CONFIG_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_NO_CONFIG_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING1_AND_BINDING2_UINT_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_AND_BINDING2_UINT_READ_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_TINY_UINT_READ_NO_CONFIG_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_TINY_UINT_READ_NO_CONFIG_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE", false);
    static final boolean CMDGEN_SINGLE_BINDING1_TINY_UINT_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_SINGLE_BINDING1_TINY_UINT_READ_PROBE", false);
    static final boolean CMDGEN_BINDING1_AS_BINDING0_TINY_UINT_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_BINDING1_AS_BINDING0_TINY_UINT_READ_PROBE", false);
    static final boolean CMDGEN_FULL_LAYOUT_BINDING2_TINY_UINT_READ_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING2_TINY_UINT_READ_PROBE", false);
    static final boolean CMDGEN_RAW_METADATA_UVEC4_BINDING0_REAL_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_RAW_METADATA_UVEC4_BINDING0_REAL_PROBE", false);
    static final boolean CMDGEN_NO_IMPORT_COMPUTE_QUAD_COUNTS_ONLY_NO_WRITE_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_COMPUTE_QUAD_COUNTS_ONLY_NO_WRITE_PROBE", false);
    static final boolean CMDGEN_NO_IMPORT_WRITE_COMMAND0_ONLY_NO_ATOMIC_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_WRITE_COMMAND0_ONLY_NO_ATOMIC_PROBE", false);
    static final boolean CMDGEN_NO_IMPORT_ATOMIC_DRAWCOUNT_ONLY_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_ATOMIC_DRAWCOUNT_ONLY_PROBE", false);
    static final boolean CMDGEN_NO_IMPORT_SINGLE_INVOCATION_REAL_COMMAND_NO_ATOMIC_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_SINGLE_INVOCATION_REAL_COMMAND_NO_ATOMIC_PROBE", false);
    static final boolean CMDGEN_DENSE_LAYOUT_NOOP_PROBE = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DENSE_LAYOUT_NOOP_PROBE", false);
    static final boolean CMDGEN_USE_DENSE_LAYOUT_NOOP_SHADER = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_USE_DENSE_LAYOUT_NOOP_SHADER", false);
    static final boolean CMDGEN_DEBUG_READBACK = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DEBUG_READBACK", false);
    static final boolean CMDGEN_DEBUG_READBACK_NO_COPY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DEBUG_READBACK_NO_COPY", false);
    static final boolean CMDGEN_DEBUG_READBACK_DRAW_COUNT_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DEBUG_READBACK_DRAW_COUNT_ONLY", false);
    static final boolean CMDGEN_DEBUG_READBACK_DRAW_COMMANDS_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DEBUG_READBACK_DRAW_COMMANDS_ONLY", false);
    static final boolean CMDGEN_DEBUG_READBACK_LOG_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DEBUG_READBACK_LOG_ONLY", false);
    static final boolean CMDGEN_DEBUG_READBACK_SCHEDULE_ENTER_ONLY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DEBUG_READBACK_SCHEDULE_ENTER_ONLY", false);
    static final boolean CMDGEN_DEBUG_READBACK_NO_BARRIERS_NO_COPY = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_CMDGEN_DEBUG_READBACK_NO_BARRIERS_NO_COPY", false);
    static final boolean ENABLE_INDIRECT_DRAW = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_ENABLE_INDIRECT_DRAW", false);
    static final boolean FORCE_FULL_CMDGEN_DISPATCH_WITH_INDIRECT_DISABLED = VulkanBerylEnvironment.flag("VOXY_VULKAN_BERYL_FORCE_FULL_CMDGEN_DISPATCH_WITH_INDIRECT_DISABLED", false);
    ...
    /**
     * Returns the env var name of the currently active cmdgen probe, or null if no probe is active.
     * Order matches the dispatch cascade in renderOpaque().
     */
    static String selectedProbeEnvVarName() {
        if (CMDGEN_MINIMAL_TINY_SSBO_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_MINIMAL_TINY_SSBO_READ_PROBE";
        if (CMDGEN_MINIMAL_RENDERLIST_MANUALUBO_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_MINIMAL_RENDERLIST_MANUALUBO_READ_PROBE";
        if (CMDGEN_MINIMAL_CONFIG_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_MINIMAL_CONFIG_READ_PROBE";
        if (CMDGEN_MINIMAL_CONFIG_BINDING0_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_MINIMAL_CONFIG_BINDING0_READ_PROBE";
        if (CMDGEN_HARDCODED_READ_BINDING0_ONLY) return "VOXY_VULKAN_BERYL_CMDGEN_HARDCODED_READ_BINDING0_ONLY";
        if (CMDGEN_FULL_LAYOUT_NOOP_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_NOOP_PROBE";
        if (CMDGEN_FULL_LAYOUT_HARDCODED_BINDING0_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_HARDCODED_BINDING0_READ_PROBE";
        if (CMDGEN_FULL_LAYOUT_CONFIG_BINDING0_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_CONFIG_BINDING0_READ_PROBE";
        if (CMDGEN_NO_IMPORT_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_PROBE";
        if (CMDGEN_NO_IMPORT_READ_METADATA0_ONLY_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_READ_METADATA0_ONLY_PROBE";
        if (CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_PROBE";
        if (CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_TINY_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_TINY_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING1_NO_READ_TINY_BIND_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_NO_READ_TINY_BIND_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_CONST_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_CONST_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_NO_CONFIG_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_NO_CONFIG_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING1_AND_BINDING2_UINT_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_AND_BINDING2_UINT_READ_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_TINY_UINT_READ_NO_CONFIG_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_TINY_UINT_READ_NO_CONFIG_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE";
        if (CMDGEN_SINGLE_BINDING1_TINY_UINT_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_SINGLE_BINDING1_TINY_UINT_READ_PROBE";
        if (CMDGEN_BINDING1_AS_BINDING0_TINY_UINT_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_BINDING1_AS_BINDING0_TINY_UINT_READ_PROBE";
        if (CMDGEN_FULL_LAYOUT_BINDING2_TINY_UINT_READ_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_FULL_LAYOUT_BINDING2_TINY_UINT_READ_PROBE";
        if (CMDGEN_RAW_METADATA_UVEC4_BINDING0_REAL_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_RAW_METADATA_UVEC4_BINDING0_REAL_PROBE";
        if (CMDGEN_NO_IMPORT_COMPUTE_QUAD_COUNTS_ONLY_NO_WRITE_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_COMPUTE_QUAD_COUNTS_ONLY_NO_WRITE_PROBE";
        if (CMDGEN_NO_IMPORT_WRITE_COMMAND0_ONLY_NO_ATOMIC_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_WRITE_COMMAND0_ONLY_NO_ATOMIC_PROBE";
        if (CMDGEN_NO_IMPORT_ATOMIC_DRAWCOUNT_ONLY_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_ATOMIC_DRAWCOUNT_ONLY_PROBE";
        if (CMDGEN_NO_IMPORT_SINGLE_INVOCATION_REAL_COMMAND_NO_ATOMIC_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_NO_IMPORT_SINGLE_INVOCATION_REAL_COMMAND_NO_ATOMIC_PROBE";
        if (CMDGEN_DENSE_LAYOUT_NOOP_PROBE) return "VOXY_VULKAN_BERYL_CMDGEN_DENSE_LAYOUT_NOOP_PROBE";
        return null;
    }

    /** Returns the shader name for the active probe, or null if no probe. */
    static String selectedProbeShaderName() {
        if (CMDGEN_MINIMAL_TINY_SSBO_READ_PROBE) return CMDGEN_MINIMAL_SSBO_READ_SHADER_NAME;
        if (CMDGEN_MINIMAL_RENDERLIST_MANUALUBO_READ_PROBE) return CMDGEN_MINIMAL_SSBO_READ_SHADER_NAME;
        if (CMDGEN_MINIMAL_CONFIG_READ_PROBE) return CMDGEN_MINIMAL_CONFIG_READ_SHADER_NAME;
        if (CMDGEN_MINIMAL_CONFIG_BINDING0_READ_PROBE) return CMDGEN_MINIMAL_CONFIG_BINDING0_READ_SHADER_NAME;
        if (CMDGEN_HARDCODED_READ_BINDING0_ONLY) return CMDGEN_HARDCODED_BINDING0_READ_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_NOOP_PROBE) return CMDGEN_FULL_LAYOUT_NOOP_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_HARDCODED_BINDING0_READ_PROBE) return CMDGEN_FULL_LAYOUT_HARDCODED_BINDING0_READ_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_CONFIG_BINDING0_READ_PROBE) return CMDGEN_FULL_LAYOUT_CONFIG_BINDING0_READ_SHADER_NAME;
        if (CMDGEN_NO_IMPORT_PROBE) return CMDGEN_NO_IMPORT_SHADER_NAME;
        if (CMDGEN_NO_IMPORT_READ_METADATA0_ONLY_PROBE) return CMDGEN_NO_IMPORT_READ_METADATA0_ONLY_SHADER_NAME;
        if (CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_PROBE) return CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_SHADER_NAME;
        if (CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_TINY_PROBE) return CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING1_NO_READ_TINY_BIND_PROBE) return CMDGEN_FULL_LAYOUT_NOOP_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_PROBE) return CMDGEN_FULL_LAYOUT_BINDING1_UINT_READ_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_CONST_PROBE) return CMDGEN_FULL_LAYOUT_BINDING1_UINT_READ_CONST_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_NO_CONFIG_PROBE) return CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_NO_CONFIG_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING1_AND_BINDING2_UINT_READ_PROBE) return CMDGEN_FULL_LAYOUT_BINDING1_AND_BINDING2_UINT_READ_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE) return CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE) return CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_CONST_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_TINY_UINT_READ_NO_CONFIG_PROBE) return CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_TINY_UINT_READ_NO_CONFIG_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE) return CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE) return CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_CONST_SHADER_NAME;
        if (CMDGEN_SINGLE_BINDING1_TINY_UINT_READ_PROBE) return CMDGEN_SINGLE_BINDING1_UINT_READ_SHADER_NAME;
        if (CMDGEN_BINDING1_AS_BINDING0_TINY_UINT_READ_PROBE) return CMDGEN_BINDING0_UINT_READ_SHADER_NAME;
        if (CMDGEN_FULL_LAYOUT_BINDING2_TINY_UINT_READ_PROBE) return CMDGEN_FULL_LAYOUT_BINDING2_UINT_READ_SHADER_NAME;
        if (CMDGEN_RAW_METADATA_UVEC4_BINDING0_REAL_PROBE) return CMDGEN_RAW_METADATA_UVEC4_BINDING0_SHADER_NAME;
        if (CMDGEN_NO_IMPORT_COMPUTE_QUAD_COUNTS_ONLY_NO_WRITE_PROBE) return CMDGEN_NO_IMPORT_COMPUTE_QUAD_COUNTS_ONLY_NO_WRITE_SHADER_NAME;
        if (CMDGEN_NO_IMPORT_WRITE_COMMAND0_ONLY_NO_ATOMIC_PROBE) return CMDGEN_NO_IMPORT_WRITE_COMMAND0_ONLY_NO_ATOMIC_SHADER_NAME;
        if (CMDGEN_NO_IMPORT_ATOMIC_DRAWCOUNT_ONLY_PROBE) return CMDGEN_NO_IMPORT_ATOMIC_DRAWCOUNT_ONLY_SHADER_NAME;
        if (CMDGEN_NO_IMPORT_SINGLE_INVOCATION_REAL_COMMAND_NO_ATOMIC_PROBE) return CMDGEN_NO_IMPORT_SINGLE_INVOCATION_REAL_COMMAND_NO_ATOMIC_SHADER_NAME;
        if (CMDGEN_DENSE_LAYOUT_NOOP_PROBE) return CMDGEN_DENSE_LAYOUT_NOOP_SHADER_NAME;
        return null;
    }

    /** Returns the isolation mode name for the active probe or null. */
    static String selectedProbeIsolationModeName() {
        if (CMDGEN_MINIMAL_TINY_SSBO_READ_PROBE) return "minimal_tiny_ssbo_read_probe";
        if (CMDGEN_MINIMAL_RENDERLIST_MANUALUBO_READ_PROBE) return "minimal_renderlist_manualubo_read_probe";
        if (CMDGEN_MINIMAL_CONFIG_READ_PROBE) return "minimal_config_read_probe";
        if (CMDGEN_MINIMAL_CONFIG_BINDING0_READ_PROBE) return "minimal_config_binding0_read_probe";
        if (CMDGEN_HARDCODED_READ_BINDING0_ONLY) return "hardcoded_read_binding0_only";
        if (CMDGEN_FULL_LAYOUT_NOOP_PROBE) return "full_layout_noop_probe";
        if (CMDGEN_FULL_LAYOUT_HARDCODED_BINDING0_READ_PROBE) return "full_layout_hardcoded_binding0_read_probe";
        if (CMDGEN_FULL_LAYOUT_CONFIG_BINDING0_READ_PROBE) return "full_layout_config_binding0_read_probe";
        if (CMDGEN_NO_IMPORT_PROBE) return "no_import_probe";
        if (CMDGEN_NO_IMPORT_READ_METADATA0_ONLY_PROBE) return "no_import_read_metadata0_only_probe";
        if (CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_PROBE) return "no_import_raw_metadata_uvec4_binding1_probe";
        if (CMDGEN_NO_IMPORT_RAW_METADATA_UVEC4_BINDING1_TINY_PROBE) return "no_import_raw_metadata_uvec4_binding1_tiny_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING1_NO_READ_TINY_BIND_PROBE) return "full_layout_binding1_no_read_tiny_bind_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_PROBE) return "full_layout_binding1_tiny_uint_read_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_CONST_PROBE) return "full_layout_binding1_tiny_uint_read_const_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_UINT_READ_NO_CONFIG_PROBE) return "full_layout_binding1_tiny_uint_read_no_config_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING1_AND_BINDING2_UINT_READ_PROBE) return "full_layout_binding1_and_binding2_uint_read_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE) return "full_layout_binding2_probe_buffer_uint_read_no_config_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE) return "full_layout_binding2_probe_buffer_uint_read_const_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_TINY_UINT_READ_NO_CONFIG_PROBE) return "full_layout_binding1_tiny_and_binding2_tiny_uint_read_no_config_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_NO_CONFIG_PROBE) return "full_layout_binding1_tiny_and_binding2_probe_buffer_uint_read_no_config_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING1_TINY_AND_BINDING2_PROBE_BUFFER_UINT_READ_CONST_PROBE) return "full_layout_binding1_tiny_and_binding2_probe_buffer_uint_read_const_probe";
        if (CMDGEN_SINGLE_BINDING1_TINY_UINT_READ_PROBE) return "single_binding1_tiny_uint_read_probe";
        if (CMDGEN_BINDING1_AS_BINDING0_TINY_UINT_READ_PROBE) return "binding1_as_binding0_tiny_uint_read_probe";
        if (CMDGEN_FULL_LAYOUT_BINDING2_TINY_UINT_READ_PROBE) return "full_layout_binding2_tiny_uint_read_probe";
        if (CMDGEN_RAW_METADATA_UVEC4_BINDING0_REAL_PROBE) return "raw_metadata_uvec4_binding0_real_probe";
        if (CMDGEN_NO_IMPORT_COMPUTE_QUAD_COUNTS_ONLY_NO_WRITE_PROBE) return "no_import_compute_quad_counts_only_no_write_probe";
        if (CMDGEN_NO_IMPORT_WRITE_COMMAND0_ONLY_NO_ATOMIC_PROBE) return "no_import_write_command0_only_no_atomic_probe";
        if (CMDGEN_NO_IMPORT_ATOMIC_DRAWCOUNT_ONLY_PROBE) return "no_import_atomic_drawcount_only_probe";
        if (CMDGEN_NO_IMPORT_SINGLE_INVOCATION_REAL_COMMAND_NO_ATOMIC_PROBE) return "no_import_single_invocation_real_command_no_atomic_probe";
        if (CMDGEN_DENSE_LAYOUT_NOOP_PROBE) return "dense_layout_noop_probe";
        return null;
    }

    static boolean isProbeSelected() {
        return selectedProbeEnvVarName() != null;
    }

    static String probeSelectionReason() {
        if (isProbeSelected()) return "selected";
        if (activeCmdgenShaderSelectionEnvVar() != null) return "enabled_cmdgen_normal";
        return "no_probe_env";
    }

    /**
     * Emit a once-per-JVM summary of all active Vulkan/Beryl test env vars.
     * Call at startup or first resource bind.
     */
    static void logActiveEnvSummaryOnce() {
        StringBuilder sb = new StringBuilder("active Vulkan/Beryl env: DEBUG_COLOUR=").append(DEBUG_COLOUR_MODE);
        sb.append(", ENABLE_CMDGEN_DISPATCH=").append(ENABLE_CMDGEN_DISPATCH);
        sb.append(", ENABLE_INDIRECT_DRAW=").append(ENABLE_INDIRECT_DRAW);
        sb.append(", TRAVERSAL_STAGE_LIMIT=").append(TRAVERSAL_STAGE_LIMIT);
        String probeEnv = selectedProbeEnvVarName();
        if (probeEnv != null) {
            sb.append(", activeProbeEnv=").append(probeEnv);
        }
        if (CMDGEN_DISPATCH_NOOP) sb.append(", CMDGEN_DISPATCH_NOOP=true");
        if (CMDGEN_CREATE_ONLY) sb.append(", CMDGEN_CREATE_ONLY=true");
        if (CMDGEN_UPLOAD_CONFIG_ONLY) sb.append(", CMDGEN_UPLOAD_CONFIG_ONLY=true");
        if (CMDGEN_CLEAR_OUTPUTS_ONLY) sb.append(", CMDGEN_CLEAR_OUTPUTS_ONLY=true");
        if (CMDGEN_BIND_FULL_ONLY) sb.append(", CMDGEN_BIND_FULL_ONLY=true");
        if (CMDGEN_DEBUG_READBACK) sb.append(", CMDGEN_DEBUG_READBACK=true");
        if (RENDERLIST_SMOKE_ONE_ENTRY) sb.append(", RENDERLIST_SMOKE_ONE_ENTRY=true");
        if (CMDGEN_USE_FULL_NO_DRAWCOUNT_WRITE_SHADER) sb.append(", CMDGEN_USE_FULL_NO_DRAWCOUNT_WRITE_SHADER=true");
        if (FORCE_FULL_CMDGEN_DISPATCH_WITH_INDIRECT_DISABLED) sb.append(", FORCE_FULL_CMDGEN_DISPATCH_WITH_INDIRECT_DISABLED=true");
        if (CMDGEN_DISPATCH_NOOP_SAME_LAYOUT) sb.append(", CMDGEN_DISPATCH_NOOP_SAME_LAYOUT=true");
        if (CMDGEN_SKIP_RENDER_DRAW_SUBMIT_AFTER_CMDGEN) sb.append(", CMDGEN_SKIP_RENDER_DRAW_SUBMIT_AFTER_CMDGEN=true");
        VulkanBerylDebugLog.once("active-vulkan-beryl-env-summary", sb.toString());
    }
